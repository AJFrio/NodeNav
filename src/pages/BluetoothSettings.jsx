...
const BluetoothSettings = () => {
  ...
  return (
    ...
    >
      ...
      {/* Available Devices - only show while discovery/scanning is active */}
      {(adapterInfo?.discovering || isScanning) && (
      ...
      {/* Adapter + Discovery moved to bottom */}
      <div style={{
        display: 'grid',
